...
class _AppApi implements AppApi {
  ...
  @override
  Future<DriverModel> getDriverByPhoneNumber(String phoneNumber) async {
    ...
    final _options = _setStreamType<DriverModel>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/v1/driver/getDriverByPhoneNumber/${phoneNumber}',
  ...
  Future<HttpResponse<String>> activateDriver(
    ...
    final _options = _setStreamType<HttpResponse<String>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/v1/registrationForm/isActive',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<HttpResponse<String>> unActivateDriver(
    ...
    final _options = _setStreamType<HttpResponse<String>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/v1/registrationForm/unActive/${driverId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<List<BookingModel>> getAllBookingsByDriverId(
    ...
    final _options = _setStreamType<List<BookingModel>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/v1/driver/getAllBooking/${driverId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<List<RegistrationFormModel>> getAllRegistrationFormsById(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<RegistrationFormModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<RegistrationFormModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              RegistrationFormModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<HttpResponse<void>> createAdvanceBooking(
    ...
    final _options = _setStreamType<HttpResponse<void>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/v1/booking/createAdvanceBooking',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
