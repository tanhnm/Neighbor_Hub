...
class MessageScreenDriverNew extends HookConsumerWidget {
  const MessageScreenDriverNew({super.key, required this.booking,});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final currentUserId = useState(booking.driverId.toString());
    ...
    void _sendMessage() async {
      ...
      if (messageText.isNotEmpty) {
        await _messagesRef.add({
          ...
          'text': messageText,
          'userId': booking.bookingDetail.user.userId.toString(),
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(booking.bookingDetail.user.username,
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: _messagesRef
                  ...
                  .where('driverId', isEqualTo: booking.driverId.toString())
